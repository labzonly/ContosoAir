[![Build Status](https://dev.azure.com/labzonly/Github%20Integration/_apis/build/status/labzonly.ContosoAir?branchName=master)](https://dev.azure.com/labzonly/Github%20Integration/_build/latest?definitionId=12&branchName=master)
